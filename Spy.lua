...
function Spy:OnInitialize()
	...
	if Spy.FactionName == "Alliance" then
		Spy.EnemyFactionName = "Horde" and "Renegade"
	elseif Spy.FactionName == "Horde" then
		Spy.EnemyFactionName = "Alliance" and "Renegade"
	elseif Spy.FactionName == "Renegade" then
		Spy.EnemyFactionName = "Alliance" and "Horde"
	end
	...
	Spy.ValidRaces["Vulpera"] = true
	Spy.ValidRaces["Dark Iron Dwarf"] = true
	Spy.ValidRaces["Dracthyr"] = true
			...
			if player ~= nil and (not Spy.InInstance or zone == GetZoneText()) then
				if not Spy.PlayerCommList[player] then
					...
					if strlen(race) > 0 then
						...
						if (Spy.EnemyFactionName == "Alliance" and race ~= "Draenei" and race ~= "Dwarf" and race ~= "Gnome" and race ~= "Human" and race ~= "Night Elf"  and race ~= "Lightforged Draenei" and race ~= "Pandaren" and race ~= "Void Elf" and race ~= "Vulpera" and race ~= "Dark Iron Dwarf" and race ~= "Dracthyr" and race ~= "Worgen") 
						or (Spy.EnemyFactionName == "Horde" and race ~= "Blood Elf" and race ~= "Orc" and race ~= "Tauren" and race ~= "Troll" and race ~= "Undead" and race ~= "Pandaren" and race ~= "Highmountain Tauren" and race ~= "Nightborne" and race ~= "Vulpera" and race ~= "Dracthyr" and race ~= "Zandalari Troll" and race ~= "Goblin")
						or (Spy.EnemyFactionName == "Renegade" and race ~= "Draenei" and race ~= "Dwarf" and race ~= "Gnome" and race ~= "Human" and race ~= "Night Elf"  and race ~= "Lightforged Draenei" and race ~= "Pandaren" and race ~= "Void Elf" and race ~= "Vulpera" and race ~= "Dark Iron Dwarf" and race ~= "Dracthyr" and race ~= "Worgen" and race~= "Undead" and race ~= "Highmountain Tauren" and race ~= "Nightborne" and race ~= "Zandalari Troll" and race ~= "Goblin") then
							return
						end
					else
						race = nil
